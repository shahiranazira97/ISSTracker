...
<body>
	...
	<p>
		<h3>Current astronaut who are at the ISS right now:</h3>
		<button id="submit" type="submit" onclick="getAstros()">Click to see</button></br></br>
	</p>
	<ul>
		<script >
		...
		document.write("Current astronaut who are at the ISS right now: ");
		document.write("<br>");
		document.write("source from:" + astros_url);
		...
		for(i=0;i<astrosdata.people.length;i++){
			...
			document.write(i + 1 +". ");
			document.write(astrosdata.people[i].name);
			document.write("<br>");
